...
plt.tight_layout()
plt.savefig('results/figures/diagonal_right_analysis.png', dpi=150, bbox_inches='tight')
print("✓ 저장: results/figures/diagonal_right_analysis.png")
plt.close()
...
print(f"\n  📊 시각화: results/figures/diagonal_right_analysis.png")
print("="*60)