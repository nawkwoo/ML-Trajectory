...
# Noise
data_dir_noise = Path("Data/noise/horizontal")
...
plt.tight_layout()
plt.savefig('results/figures/horizontal_analysis.png', dpi=150, bbox_inches='tight')
print("✓ 저장: results/figures/horizontal_analysis.png")
plt.close()
