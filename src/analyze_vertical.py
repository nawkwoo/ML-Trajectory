...
plt.tight_layout()
plt.savefig('results/figures/vertical_analyze.png', dpi=150, bbox_inches='tight')
print("✓ 저장: results/figures/vertical_analyze.png")
plt.close()

# 결론
print("\n" + "="*60)
print("✓ vertical 분석 완료!")
print("="*60)
